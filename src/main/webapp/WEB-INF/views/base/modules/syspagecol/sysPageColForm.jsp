...
<body>
	...
	<form:form id="inputForm" modelAttribute="sysPageCol" action="${ctx}/syspagecol/sysPageCol/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:textarea readonly="true" path="moduleName" htmlEscape="false" rows="4" maxlength="50" class="input-xxlarge required"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:textarea readonly="true" path="entityName" htmlEscape="false" rows="4" maxlength="100" class="input-xxlarge required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<form:textarea readonly="true" path="viewPath" htmlEscape="false" rows="4" maxlength="100" class="input-xxlarge required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<form:textarea readonly="true" path="viewName" htmlEscape="false" rows="4" maxlength="50" class="input-xxlarge required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<form:textarea readonly="true" path="colAll" htmlEscape="false" rows="4" maxlength="1000" class="input-xxlarge required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
